             ...
             <form className="m-2 mt-3">
               <div className="form-row">
                 <div className="form-group col-12">
                   <label className="ml-2 text-muted" for="inputAddress">
                     Idea Title
                   </label>
                   <input
                     type="text"
                 ...
                 <div className="form-group col-md-6">
                   <label className="ml-2 text-muted " for="inputEmail4">
                     Idea Title
                   </label>
                   <input
                     type="text"
                 ...
                 <div className="form-group col-md-6">
                   <label className="ml-2 text-muted" for="inputPassword4">
                     Idea Title
                   </label>
                   <input
                     type="text"
               ...
               <button
                 type="submit"
                 className="btn ml-2 mt-5 w-25  mr-2 p-3 shadow mb-5   btn-primary"
               >
                 {" "}
