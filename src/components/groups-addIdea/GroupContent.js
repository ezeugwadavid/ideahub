import React, { Component } from 'react'
 ...
 class GroupContent extends Component {
    render() {
        return (
            <div className="container form-content">
                <div className="row">
                    <div className="col-8 shadow border ">
                <form className="m-2 mt-3">
  <div className="form-row">
  <div className="form-group col-12">
    <label className="ml-2" for="inputAddress">Idea Title</label>
    <input type="text" className="form-control" id="inputAddress" placeholder="Title" />
  </div>
    <div className="form-group col-md-6">
      <label className="ml-2" for="inputEmail4">Idea Title</label>
      <input type="text" className="form-control" id="inputEmail4" />
    </div>
    <div className="form-group col-md-6">
      <label className="ml-2" for="inputPassword4">Idea Title</label>
  ...
  <button type="submit" className="btn ml-2 mt-5 w-25  mr-2 p-3 shadow mb-3  btn-primary"> <i className="fas fa-cloud-upload-alt"></i> Upload</button>
</form>
</div>
<div className="col-sm-4 ml-1 right-card add-idea-card   mb-4 shadow  border bg-white">
