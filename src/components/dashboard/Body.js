  ...
  return (
    <div className="container">
      <div className="welcome">
        <p>
          Welcome Back, <span className="name">John!</span>
        </p>
      </div>
      ...
      <div className="display">
        <div className="card first-one mt-4 ">
          <div className="card-body">
            ...
            <h5 className="card-title">All ideas</h5>
          </div>
        </div>
        ...
        <div className="card rejected mt-4">
          <div className="card-body">
            ...
            <h5 className="card-title text-white">Rejected</h5>
          </div>
        </div>
      ...
      <div className="cards">
        <div className="card mt-5 card-img mb-3">
          <img
            src="https://cdn.pixabay.com/photo/2014/07/05/08/30/lawnmower-384589_1280.jpg"
            class="card-img-top"
            alt="..."
          />
          <div className="card-body">
